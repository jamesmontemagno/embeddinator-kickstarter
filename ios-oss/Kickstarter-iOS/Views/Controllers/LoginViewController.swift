...
internal final class LoginViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    /*let weather = XAMWeatherFetcher.init(city: "Seattle", state: "WA")
    let result = weather?.getWeather();
    
    UIAlertView.init(title: result?.temp, message: result?.text, delegate: nil, cancelButtonTitle: "OK").show()*/
